        ...
        <>
            {formSubmit ? (
                <>
                    <SignInForm />
                    <span></span>
                    <h4 className='sucess'>Enregistrement reussi, veuillez-vous connectez</h4>
                </>
            ) : (
                <form action="" onSubmit={handleRegister} id='sign-up-form'>
                    ...
                    <br />
                    <input type="password" name='password' id='password-conf' onChange={(e) =>
                    ...
                    <div className="terms errors"></div>
                    <br />
